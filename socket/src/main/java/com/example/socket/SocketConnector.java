...
public class SocketConnector {
                ...
                switch(msg.what) {
                    ...
                    case REMOVE_CLIENT_SOCKET: {
                        ...
                        if (p != null) {
                            ...
                            for(EventCallback c : mCallbacks) {
                                c.onClientStatusChanged(name, STATUS_DISCONNECTED);
                            }
                        }
                        break;
                    }
    ...
    public void disconnect(String name) {
        Message msg = null;
        if(mClients.containsKey(name)) {
            msg = mHandler.obtainMessage(REMOVE_CLIENT_SOCKET);
        } else if(mRemotes.containsKey(name)) {
            msg = mHandler.obtainMessage(DISCONNECT_REMOTE);
        }
        if(msg != null) {
            Bundle b = new Bundle();
