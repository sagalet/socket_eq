...
Java_com_jshipster_eq_EqualizerImpl_nativeInit(
...
Java_com_jshipster_eq_EqualizerImpl_nativeEnableEq(
...
JNIEXPORT bool JNICALL
Java_com_jshipster_eq_EqualizerImpl_nativeAdjustEq(
...
Java_com_jshipster_eq_EqualizerImpl_nativeGetEqState(
        JNIEnv *env, jobject obj) {
    if(g_ctx.enable!=-1) {
        char buf[4] = {0};
...
Java_com_jshipster_eq_EqualizerImpl_nativeGetEqFrequency(
...
JNIEXPORT jint JNICALL
Java_com_jshipster_eq_EqualizerImpl_nativeGetEqValue(
        JNIEnv *env, jobject obj, int index) {
...
JNIEXPORT void JNICALL
Java_com_jshipster_eq_EqualizerImpl_nativeRelease(
        JNIEnv *env, jobject obj){
    release();
}
}